...
class BulletListHelper {
    static func createBulletedList(fromStringArray strings: [String], font: UIFont? = nil, isNumbered numberedList: Bool = false) -> NSAttributedString {
        ...
        for index in 0..<strings.count {
            let bulletPoint: String = numberedList ? String(index+1) + "." : "\u{2022}"
            ...
            let paragraphStyle = BulletListHelper.createParagraphAttribute()
